...
class InverseAutoregressiveFlow(Transform):
    ...
    def __init__(self, input_dim, hidden_dim, permutation=None): #sigmoid_bias=2
        ...
        self.module.arn = AutoRegressiveNN(input_dim, hidden_dim, permutation=permutation, param_dims=[1, 1], nonlinearity=torch.nn.ELU())
    ...
    def _call(self, x):
        ...
        scale = self.module.activation(hidden[:, 0:self.input_dim] + hidden.new_tensor(self.module.sigmoid_bias))
